...
class LoginScreen extends StatelessWidget {
                      ...
                      RaisedButton(
                        ...
                        onPressed: ()
                        {
                          if(!textEditingControllerEmail.text.contains("@")){
                            ...
                            displayToastMessage("Email address cannot empty",context);
                          }
  ...
  void loginUser(BuildContext context) async{
    ...
    if(firebaseUser != null){
      databaseReference.child(firebaseUser.uid).once().then((event){
        ...
        if(snap.value!=null){
          ...
          displayToastMessage("user doesnt exists please create new account", context);
        }
      });
      }
    else
